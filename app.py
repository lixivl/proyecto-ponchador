...
class InterfazDepurador(tk.Tk):
    ...
    def _construir_layout(self):
        ...
        # --- Barra de estado ---
        self.lbl_estado = ttk.Label(self, text="Listo", anchor="w", padding=(10, 4))
    ...
    def _agregar_archivo(self):
        ...
        self.df_depurado = None
        self.lbl_archivo.config(text=os.path.basename(ruta), foreground="#000000")
        ...
        self.lbl_estado.config(text=f"Archivo cargado: {os.path.basename(ruta)}")
    ...
    def _descargar(self):
        if self.df_depurado is None:
            return
        nombre_sugerido = (
            os.path.splitext(os.path.basename(self.nombre_archivo))[0] + "_depurado.csv"
        )
        ...
        messagebox.showinfo("Listo", "El archivo depurado se guardó correctamente.")
